...
/**
 * Movement placeholder. Deliberately without settings until a real step-height implementation
 * exists - a slider that changes nothing would be a fake setting.
 */
public class StepModule extends Module {

	public StepModule() {
		super("Step", "Platzhalter: hoeheres Treppensteigen (noch keine Gameplay-Logik).", ModuleCategory.MOVEMENT);
	}
