 ...
 *
 * SITE_URL is the single source of truth for canonical URLs, Open Graph and the
 * sitemap. Update it once when the real domain goes live — nothing else needs
 * to change. Until then the GitHub Pages URL is used.
 */
window.SITE = {
  // Canonical origin, no trailing slash. Replace with the real domain later.
  siteUrl: "https://fakten60-svg.github.io/gugugaga-client",

  clientName: "Gugugaga Client",
  tagline: "Modern Minecraft Client for 1.21.11",
  description:
